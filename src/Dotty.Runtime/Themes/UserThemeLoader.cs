...
/// <summary>
/// Loads user-defined themes from the shared platform configuration directory.
...
public sealed class UserThemeLoader
{
    ...
    /// <summary>
    /// Gets the default themes directory path using the shared platform policy.
    /// </summary>
    private static string GetDefaultThemesDirectory() => PlatformPaths.ThemesDirectory;
}
