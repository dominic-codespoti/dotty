...
namespace Dotty.Runtime.Themes;
...
public sealed class ThemeManager
{
    ...
    public bool ApplyTheme(string name)
    {
        ...
        if (theme == null)
        {
            ...
            theme = Dotty.Abstractions.Themes.BuiltInThemes.DarkPlus;
        }
    ...
    {
        return _registry.GetByName(name) ?? Dotty.Abstractions.Themes.BuiltInThemes.DarkPlus;
    }
    ...
    {
        if (ReferenceEquals(theme, Dotty.Abstractions.Themes.BuiltInThemes.DarkPlus)) return "DarkPlus";
        if (ReferenceEquals(theme, Dotty.Abstractions.Themes.BuiltInThemes.Dracula)) return "Dracula";
        if (ReferenceEquals(theme, Dotty.Abstractions.Themes.BuiltInThemes.OneDark)) return "OneDark";
        if (ReferenceEquals(theme, Dotty.Abstractions.Themes.BuiltInThemes.GruvboxDark)) return "GruvboxDark";
        if (ReferenceEquals(theme, Dotty.Abstractions.Themes.BuiltInThemes.CatppuccinMocha)) return "CatppuccinMocha";
        if (ReferenceEquals(theme, Dotty.Abstractions.Themes.BuiltInThemes.TokyoNight)) return "TokyoNight";
        if (ReferenceEquals(theme, Dotty.Abstractions.Themes.BuiltInThemes.LightPlus)) return "LightPlus";
        if (ReferenceEquals(theme, Dotty.Abstractions.Themes.BuiltInThemes.OneLight)) return "OneLight";
        if (ReferenceEquals(theme, Dotty.Abstractions.Themes.BuiltInThemes.GruvboxLight)) return "GruvboxLight";
        if (ReferenceEquals(theme, Dotty.Abstractions.Themes.BuiltInThemes.CatppuccinLatte)) return "CatppuccinLatte";
        if (ReferenceEquals(theme, Dotty.Abstractions.Themes.BuiltInThemes.SolarizedLight)) return "SolarizedLight";
        return "Unknown";
    }
    ...
    private static IColorScheme GetInitialTheme()
    {
        ...
        return Dotty.Abstractions.Themes.BuiltInThemes.DarkPlus;
    }
}
