...
public sealed partial class UnixPty
{
    ...
    [DllImport(LibSystem)]
    internal static extern int cfsetispeed(ref Termios termios, uint speed);

    // int cfsetospeed(struct termios *, speed_t);
    [DllImport(LibSystem)]
    internal static extern int cfsetospeed(ref Termios termios, uint speed);
    ...
    [DllImport(LibSystem, SetLastError = true)]
    internal static extern int chdir([MarshalAs(UnmanagedType.LPStr)] string path);
    ...
    [DllImport(LibSystem, SetLastError = true)]
    internal static extern int execv(
